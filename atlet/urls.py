...
from atlet.views import daftar_sponsor, form_tes_kualifikasi, tes_kualifikasi, daftar_event, detail_stadium, detail_event, dashboard_atlet
...
urlpatterns = [
    ...
    path('form-kualifikasi/tes-kualifikasi/', tes_kualifikasi, name='tes_kualifikasi' ),
